<?php  
	$team_subtitle		= get_theme_mod('team_subtitle','<h2>Outstanding</h2><div class="animation"><div class="first"><div>Team</div></div></div>');
	$team_description	= get_theme_mod('team_description','Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'); 
