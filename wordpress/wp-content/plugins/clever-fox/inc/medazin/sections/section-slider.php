...
<?php  
	...
	$slide_title					= get_theme_mod('slide_title','We Care About You');
	$slide_subtitle					= get_theme_mod('slide_subtitle','Health Care');
	$slide_text						= get_theme_mod('slide_text','It is a long established fact that a reader will be distracted by readable content of a page when looking at its layout. The point of using Lorem ipsum');
	$slide_button					= get_theme_mod('slide_button','Get Started');
