<?php  
	$cta_call_title		= get_theme_mod('cta_call_title','Make Appointment'); 
	$cta_call_text		= get_theme_mod('cta_call_text','+12 345 678 90');
	$cta_right_icon		= get_theme_mod('cta_right_icon','fa-phone'); 
	$cta_title			= get_theme_mod('cta_title','We Care About Your Health!');
	$cta_description	= get_theme_mod('cta_description','Need An Emergency help?');
