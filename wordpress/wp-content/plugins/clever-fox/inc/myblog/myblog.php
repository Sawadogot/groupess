...
require CLEVERFOX_PLUGIN_DIR . 'inc/myblog/features/fiona-blog-lifestyle.php';
...
if ( ! function_exists( 'cleverfox_fiona_blog_frontpage_sections' ) ) :
	function cleverfox_fiona_blog_frontpage_sections() {
		...
		require CLEVERFOX_PLUGIN_DIR . 'inc/myblog/sections/fiona-blog-lifestyle.php';
    }
...
function myblog_customize_remove( $wp_customize ) {
	$wp_customize->remove_section('slider_setting');
}
add_action( 'customize_register', 'myblog_customize_remove' );